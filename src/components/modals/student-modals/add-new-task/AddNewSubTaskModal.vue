<template>
  ...
  <div
    class="modal fade"
    id="kt_modal_add_subtask"
    ref="newSubTaskModalRef"
    tabindex="-1"
    aria-hidden="true"
  >
    <!--begin::Modal dialog-->
        ...
        <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
          ...
          >
            ...
            <div class="mb-13 text-center">
              <!--begin::Title-->
              <h1 class="mb-3">Créer une nouvelle sous-tâche</h1>
            ...
            <div class="d-flex flex-column mb-8">
              ...
              <el-form-item prop="description">
                <el-input
                  ...
                  rows="3"
                  name="description"
                  placeholder="Type tâche Details"
                />
              </el-form-item>
              <el-input
                style="display: none"
...
export default defineComponent({
  ...
  setup(props, context: SetupContext) {
    ...
    const newSubTaskModalRef = ref<null | HTMLElement>(null);
    const loading = ref<boolean>(false);
    const store = useProjectStore();
    const members = ref([]);
    const route = useRoute();
    const IdParent = ref(props.id || 0);
    ...
    const submit = () => {
      ...
      formRef.value.validate(async (valid: boolean) => {
        if (valid) {
          loading.value = true;
          targetData.value.parent_id = IdParent.value;
          try {
            //Send  request
            ...
            if (!error.length) {
              Swal.fire({
                ...
                // Refresh page data
                loading.value = false;
                hideModal(newSubTaskModalRef.value);
                EmitReloadTasks();
                // router.push({
                //   name: "project-tasks",
                //   params: {
