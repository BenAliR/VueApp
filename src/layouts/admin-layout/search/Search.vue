...
import Results from "@/layouts/admin-layout/search/partials/Results.vue";
import PartialMain from "@/layouts/admin-layout/search/partials/Main.vue";
import Empty from "@/layouts/admin-layout/search/partials/Empty.vue";
