    ...
    >
      ...
      >
        <div
          ...
          title="User profile"
        >
          <img :src="url + userstore.user.photo" alt="metronic" />
        </div>
...
import KTQuickLinksMenu from "@/layouts/admin-layout/menus/QuickLinksMenu.vue";
import KTNotificationsMenu from "@/layouts/admin-layout/menus/NotificationsMenu.vue";
import KTUserMenu from "@/layouts/admin-layout/menus/UserAccountMenu.vue";
