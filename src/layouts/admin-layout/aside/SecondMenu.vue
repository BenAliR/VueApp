<template>
  <!--begin::second_menu wrapper-->
  <div
    id="kt_aside_second_menu_wrapper"
    ref="scrollElRef"
    ...
    data-kt-scroll-wrappers="#kt_aside_second_menu"
  >
    <!--begin::second_menu-->
    <div
      id="#kt_header_second_menu"
...
import MainMenuConfig from "@/core/config/AdminSecondMenuConfig";
