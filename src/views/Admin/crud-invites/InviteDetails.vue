<template>
  <!--begin::Layout-->
  <div class="d-flex flex-column flex-xl-row" v-if="invite">
    <!--begin::Sidebar-->
        ...
        <div class="card-body pt-15">
          ...
          <div class="d-flex flex-center flex-column mb-5">
            ...
            <div class="symbol symbol-100px symbol-circle mb-7">
              <img :src="url + invite.photo" alt="image" />
            </div>
            <!--end::Avatar-->
          ...
          <div class="d-flex flex-stack fs-4 py-3">
            <div
              ...
              href="#kt_invite_view_details"
              role="button"
              aria-expanded="false"
              aria-controls="kt_invite_view_details"
            >
              Détails
            </div>
          </div>
          ...
          <div id="kt_invite_view_details" class="collapse show">
            <div class="py-5 fs-6">
              <!--begin::Badge-->
              ...
              <div class="text-gray-600">
                {{ invite.encadrement.adresse }}
              </div>

              <!--begin::Details item-->
              <div class="fw-bold mt-5">Téléphone</div>
              <div class="text-gray-600">
                {{ invite.encadrement.telephone }}
              </div>
              <!--begin::Details item-->
            </div>
          </div>
    ...
    <div class="flex-lg-row-fluid ms-lg-15">
      ...
      >
        ...
        <li class="nav-item">
          <a
            ...
            data-bs-toggle="tab"
            href="#kt_invite_view_overview_tab"
            >Overview</a
          >
        </li>
        <!--end:::Tab item-->
        ...
        <li class="nav-item">
          <a
            ...
            data-bs-toggle="tab"
            href="#kt_invite_view_overview_events_and_logs_tab"
            >Events & Logs</a
          >
        </li>
        <!--end:::Tab item-->
        ...
        <li class="nav-item">
          <a
            ...
            data-bs-toggle="tab"
            href="#kt_invite_view_overview_statements"
            >Statements</a
          >
        </li>
        <!--end:::Tab item-->
      ...
      <div class="tab-content" id="myTabContent">
        ...
        <div
          ...
          id="kt_invite_view_overview_tab"
          role="tabpanel"
        >
          <!--begin::Card-->
        ...
        <div
          class="tab-pane fade"
          id="kt_invite_view_overview_events_and_logs_tab"
          role="tabpanel"
        >
        ...
        <div
          class="tab-pane fade"
          id="kt_invite_view_overview_statements"
          role="tabpanel"
        >
        ...
        <!--end:::Tab pane-->
        <!--begin:::Tab pane-->
        <div class="tab-pane fade" id="kt_invite_edit_view" role="tabpanel">
          <!--begin::Basic info-->
          <div class="card mb-5 mb-xl-10">
            ...
            <div
              ...
              role="button"
              data-bs-toggle="collapse"
              data-bs-target="#kt_account__invite_profile_details"
              aria-expanded="true"
              aria-controls="kt_account__invite_profile_details"
            >
              <!--begin::Card title-->
            ...
            <!--begin::Content-->
            <div id="kt_account__invite_profile_details" class="collapse show">
              <!--begin::Form-->
              <VForm
                id="kt_account__invite_profile_details_update_form"
                class="form"
                novalidate
                @submit="saveChanges1()"
              ...
              >
                  ...
                  <div class="row mb-6">
                    ...
                    <div class="col-lg-8 fv-row">
                      <Field
                        ...
                        v-model="profileDetails.etablissement"
                      />
                      <div class="fv-plugins-message-container">
                        <div class="fv-help-block">
                  ...
                  <div class="row mb-6">
                    ...
                    <div class="col-lg-8 fv-row">
                      <Field
                        ...
                        v-model="profileDetails.profession"
                      />
                      <div class="fv-plugins-message-container">
                        <div class="fv-help-block">
                ...
                <div class="card-footer d-flex justify-content-end py-6 px-9">
                  ...
                  <button
                    type="submit"
                    id="kt_account__invite_profile_details_submit"
                    ref="submitInviteForm"
...
export default defineComponent({
  ...
  setup() {
      ...
      if (JwtService.getToken()) {
        try {
          ...
          const response = await ApiService.get(
            "admin/users/invites/" + route.params.id
          );

          invite.value = response.data.data;
          if (invite.value !== null) {
            profileDetails.value = invite.value["encadrement"];
    ...
    const getInviteProjects = async () => {
      if (JwtService.getToken()) {
        try {
          ApiService.setHeader();
          const response = await ApiService.get(
            "admin/users/invites/projects/" + route.params.id
          );
          projects.value = response.data.data;
          console.log("invite:", projects.value);
        } catch (error) {
          if (typeof error === "object" && error !== null) {
            Swal.fire({
              text: error["response"]["data"]["errors"][0] as string,
    ...
    const updatePassword = async () => {
      if (updatePasswordForm.value) {
        ...
        //Send update email request
        await store.UpdateInvitePassword(
    ...
    const submitInviteForm = ref<HTMLElement | null>(null);
    const saveChanges1 = async () => {
      console.log("test", profileDetails.value.user_id);
      if (submitInviteForm.value) {
        // Activate indicator
        submitInviteForm.value.setAttribute("data-kt-indicator", "on");
        setTimeout(() => {
          submitInviteForm.value?.removeAttribute("data-kt-indicator");
        }, 2000);
        ...
        try {
          const response = await store.UpdateInvite(
