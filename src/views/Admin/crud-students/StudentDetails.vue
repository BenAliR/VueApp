<template>
  <!--begin::Layout-->
  <div class="d-flex flex-column flex-xl-row" v-if="student">
    <!--begin::Sidebar-->
        ...
        <div class="card-body pt-15">
          ...
          <div class="d-flex flex-center flex-column mb-5">
            ...
            <div class="symbol symbol-100px symbol-circle mb-7">
              <img :src="url + student.photo" alt="image" />
            </div>
            <!--end::Avatar-->
            ...
            <div class="d-flex flex-wrap flex-center">
              ...
              >
                ...
                <div class="fw-semobold text-muted">Projets</div>
              </div>
              <!--end::Stats-->
            </div>
            <!--end::Info-->
          ...
          <div class="d-flex flex-stack fs-4 py-3">
            <div
              ...
              role="button"
              aria-expanded="false"
              aria-controls="kt_student_view_details"
            >
              Détails
            </div>
          </div>
          ...
          <div id="kt_student_view_details" class="collapse show">
            <div class="py-5 fs-6">
              <!--begin::Badge-->
              ...
              <div class="text-gray-600">
                {{ student.demande.adresse }}
              </div>
              <!--begin::Details item-->
              <!--begin::Details item-->
              <div class="fw-bold mt-5">Pays</div>
              <div class="text-gray-600">{{ student.demande.country }}</div>
              <!--begin::Details item-->
              <!--begin::Details item-->
              <div class="fw-bold mt-5">Téléphone</div>
              <div class="text-gray-600">{{ student.demande.telephone }}</div>
              <!--begin::Details item-->
            </div>
          </div>
          <!--end::Details content-->
    ...
    <div class="flex-lg-row-fluid ms-lg-15">
      ...
      >
        ...
        <li class="nav-item">
          <a
            ...
            data-bs-toggle="tab"
            href="#kt_student_view_overview_tab"
            >Overview</a
          >
        </li>
        <!--end:::Tab item-->
        ...
        <li class="nav-item">
          <a
            ...
            data-bs-toggle="tab"
            href="#kt_student_view_overview_events_and_logs_tab"
            >Events & Logs</a
          >
        </li>
        <!--end:::Tab item-->
        ...
        <li class="nav-item">
          <a
            ...
            data-bs-toggle="tab"
            href="#kt_student_view_overview_statements"
            >Statements</a
          >
        </li>
        <!--end:::Tab item-->
      ...
      <div class="tab-content" id="myTabContent">
        ...
        <div
          ...
          id="kt_student_view_overview_tab"
          role="tabpanel"
        >
          <!--begin::Card-->
            ...
            <div class="card-header border-0">
              ...
              <div class="card-toolbar">
                ...
                <button
                  ...
                  data-bs-target="#kt_modal_create_project_app"
                >
            ...
            <div class="card-body pt-0 pb-5">
              ...
              >
                <template v-slot:title="{ row: project }">
                  <span class="task-title fs-6 fw-semibold text-gray-600 mb-5">
                    {{ project.title }}
                  </span>
                </template>
                ...
                <template v-slot:description="{ row: project }">
                  <span class="task-title fs-6 fw-semibold text-gray-600 mb-5">
                    {{ project.description }}
                  </span>
                </template>
                <template v-slot:duedate="{ row: project }">
                    ...
                    <template #dropdown>
                      <el-dropdown-menu>
                        <el-dropdown-item>
                          ...
                          ></el-dropdown-item
                        >
                        <el-dropdown-item @click="deleteRecord(project.id)"
        ...
        <div
          class="tab-pane fade"
          id="kt_student_view_overview_events_and_logs_tab"
          role="tabpanel"
        >
        ...
        <div
          class="tab-pane fade"
          id="kt_student_view_overview_statements"
          role="tabpanel"
        >
        ...
        <!--end:::Tab pane-->
        <!--begin:::Tab pane-->
        <div class="tab-pane fade" id="kt_student_edit_view" role="tabpanel">
          <!--begin::Basic info-->
          <div class="card mb-5 mb-xl-10">
            ...
            <div
              ...
              role="button"
              data-bs-toggle="collapse"
              data-bs-target="#kt_account__student_profile_details"
              aria-expanded="true"
              aria-controls="kt_account__student_profile_details"
            >
              <!--begin::Card title-->
            ...
            <!--begin::Content-->
            <div id="kt_account__student_profile_details" class="collapse show">
              <!--begin::Form-->
              <VForm
                id="kt_account__student_profile_details_update_form"
                class="form"
                novalidate
                @submit="saveChanges1()"
              ...
              >
                ...
                <div class="card-footer d-flex justify-content-end py-6 px-9">
                  ...
                  <button
                    type="submit"
                    id="kt_account__student_profile_details_submit"
                    ref="submitStudentForm"
        ...
        <div class="modal-body py-lg-10 px-lg-10">
          ...
          >
            ...
            <div class="flex-row-fluid py-lg-5 px-lg-15">
              <!--begin::Form-->
              <CreateAppModalForm :stepperEl="createAppStepperRef"    @after-hide="loadData" />
              <!--end::Form-->
            </div>
            <!--end::Content-->
          </div>
  ...
  setup() {
      ...
      if (JwtService.getToken()) {
        try {
          ...
          const response = await ApiService.get(
            "admin/users/students/" + route.params.id
          );

          student.value = response.data.data;
          if (student.value !== null) {
            profileDetails.value = student.value["demande"];
    ...
    const getStudentProjects = async () => {
      if (JwtService.getToken()) {
        try {
          ApiService.setHeader();
          const response = await ApiService.get(
            "admin/users/students/projects/" + route.params.id
          );
          projects.value = response.data.data;
          console.log("student:", projects.value);
        } catch (error) {
          if (typeof error === 'object' && error !== null){
            Swal.fire({
              text: error["response"]["data"]["errors"][0] as string,
    ...
    const updateEmail = async () => {
      ...
      if (updateEmailForm.value) {
        ...
        await store.UpdateStudentEmail(
    ...
    const updatePassword = async () => {
      if (updatePasswordForm.value) {
        ...
        //Send update email request
        await store.UpdateStudentPassword(
    ...
    const submitStudentForm = ref<HTMLElement | null>(null);
    const saveChanges1 = async () => {
      console.log("test", profileDetails.value.user_id);
      if (submitStudentForm.value) {
        // Activate indicator
        submitStudentForm.value.setAttribute("data-kt-indicator", "on");
        setTimeout(() => {
          submitStudentForm.value?.removeAttribute("data-kt-indicator");
        }, 2000);
