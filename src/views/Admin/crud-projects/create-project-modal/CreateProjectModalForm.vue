<template>
  <!--begin::Form-->
  <form class="form" id="kt_student_modal_create_app_form" @submit="handleStep">
    <!--begin::Step 1-->
          ...
          <div class="row mb-2" data-kt-buttons="true">
            ...
            <div class="col">
              ...
              <Field
                ...
                class="btn-check"
                name="team_size"
                id="StudentAccountTeamSize2"
                value="2-5"
                v-model="formData.team_size"
              />
              <label
                class="btn btn-outline btn-outline-dashed btn-outline-default w-100 p-4"
                for="StudentAccountTeamSize2"
              >
            ...
            <div class="col">
              ...
              <Field
                ...
                class="btn-check"
                name="team_size"
                id="StudentAccountTeamSize3"
                value="5-10"
                v-model="formData.team_size"
              />
              <label
                class="btn btn-outline btn-outline-dashed btn-outline-default w-100 p-4"
                for="StudentAccountTeamSize3"
              >
            ...
            <div class="col">
              ...
              <Field
                ...
                class="btn-check"
                name="team_size"
                id="StudentAccountTeamSize4"
                value="10+"
                v-model="formData.team_size"
              />
              <label
                class="btn btn-outline btn-outline-dashed btn-outline-default w-100 p-4"
                for="StudentAccountTeamSize4"
              >
...
const formSubmit = async () => {
  ...
  await store.CreateStudentProject(formData.value, route.params.id);
